...
\end{align*}
où $\mu_i$ est l'espérance (moyenne théorique) de la variable aléatoire $X_i$, où $\boldsymbol{\Gamma}$ est une matrice $p \times m$ avec éléments $\gamma_{ij}$, qui représentent le chargement de la variable $X_i$ sur le facteur $F_j$ ($i=1, \ldots, p$; $j=1, \ldots, m$).
