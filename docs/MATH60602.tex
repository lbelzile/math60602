...
\addcontentsline{toc}{subsubsection}{Code R}

Le chiffrier \texttt{factor2.csv} contient les observations pour ces 12 questions. Tout d'abord, les statistiques descriptives ainsi que la matrice des corrélations qui suivent sont obtenues en exécutant les lignes suivantes:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{path <-}\StringTok{ "https://lbelzile.bitbucket.io/MATH60602/factor.csv"}
\NormalTok{facto <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\DataTypeTok{file =}\NormalTok{ path, }\DataTypeTok{header =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{cormat <-}\StringTok{ }\KeywordTok{cor}\NormalTok{(facto, }\DataTypeTok{method =} \StringTok{"pearson"}\NormalTok{)}
\KeywordTok{round}\NormalTok{(cormat, }\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{code-sas}{%
\subsubsection*{Code SAS}\label{code-sas}}
\addcontentsline{toc}{subsubsection}{Code SAS}
