...
\end{align*}
où $z_{i, 1}, \ldots, x_{i, 12}$ sont les valeurs centrées et réduites des observations correspondant à l'individu et où $\widehat{\gamma}_{1, k}, \ldots, \widehat{\gamma}_{12, k}$ sont des coefficients estimés à partir des chargements $l_{ij}$ (après rotation) et de la matrice de corrélation des variables $\mathbf{R}$, avec $\widehat{\gamma}_{i, k}=\sum_{j=1}^p \hat{l}_{kj}r_{jk}$.
