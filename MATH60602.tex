...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toptitle=1mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, coltitle=black, bottomrule=.15mm, colback=white, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{En résumé}, arc=.35mm, left=2mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toptitle=1mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, coltitle=black, bottomrule=.15mm, colback=white, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Danger de surajustement avec variables catégorielles}, arc=.35mm, left=2mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toptitle=1mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, coltitle=black, bottomrule=.15mm, colback=white, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Étapes de l'analyse factorielle exploratoire}, arc=.35mm, left=2mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toptitle=1mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, coltitle=black, bottomrule=.15mm, colback=white, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Étapes d'une analyse de regroupements}, arc=.35mm, left=2mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame]
...
{\centering \includegraphics{regroupements_files/figure-pdf/fig-dbscan1-1.pdf}
...
{\centering \includegraphics{regroupements_files/figure-pdf/fig-dbscan2-1.pdf}
...
\addcontentsline{toc}{chapter}{Régression linéaire}

\markboth{Régression linéaire}{Régression linéaire}
...
\addcontentsline{toc}{section}{Exemple et motivation}

\markright{Exemple et motivation}
...
\(\texttt{college}\): répartition des salaires en fonction de l'échelon
et du nombre d'années de service}
...
\NormalTok{modlin1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(salaire }\SpecialCharTok{\textasciitilde{}}\NormalTok{ service, }\AttributeTok{data =}\NormalTok{ college)}
...
\addcontentsline{toc}{section}{Interprétation des paramètres du modèles}

\markright{Interprétation des paramètres du modèles}
...
\FunctionTok{coef}\NormalTok{(}\FunctionTok{lm}\NormalTok{(salaire }\SpecialCharTok{\textasciitilde{}} \DecValTok{1}\NormalTok{, }\AttributeTok{data =}\NormalTok{ college))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(college}\SpecialCharTok{$}\NormalTok{salaire)}
\end{Highlighting}
\end{Shaded}
...
données \(\texttt{college}\) en fonction de la variable binaire sexe:
bien que le modèle définisse une ligne, seule la valeur en \(0\) et
\(1\) est réalisable.}
...
\FunctionTok{levels}\NormalTok{(college}\SpecialCharTok{$}\NormalTok{sexe)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{coef}\NormalTok{(}\FunctionTok{lm}\NormalTok{(salaire }\SpecialCharTok{\textasciitilde{}}\NormalTok{ sexe, }\AttributeTok{data =}\NormalTok{ college))}
\end{Highlighting}
\end{Shaded}
...
\texttt{college}, on obtient un salaire moyen de
...
\addcontentsline{toc}{subsection}{Polynômes}
...
On considère les données \texttt{college} et un modèle de régression qui
inclut le sexe, l'échelon académique, le nombre d'années de service et
le domaine d'expertise (appliquée ou théorique).
...
\(\texttt{college}\) (en dollars USD, arrondis à l'unité). }\tabularnewline
...
\addcontentsline{toc}{section}{Budget pour l'estimation}

\markright{Budget pour l'estimation}
