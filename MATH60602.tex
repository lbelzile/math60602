...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, coltitle=black, bottomtitle=1mm, leftrule=.75mm, breakable, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Étapes de l'analyse factorielle exploratoire}, colframe=quarto-callout-tip-color-frame, arc=.35mm, toprule=.15mm, bottomrule=.15mm, toptitle=1mm, left=2mm, opacitybacktitle=0.6]
...
multipliée par
\(\exp(`r `sprintf(round(as.numeric(coef(multi2a)),3), fmt = "%.3f")` = 0.847
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, coltitle=black, bottomtitle=1mm, leftrule=.75mm, breakable, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Étapes d'une analyse de regroupements}, colframe=quarto-callout-tip-color-frame, arc=.35mm, toprule=.15mm, bottomrule=.15mm, toptitle=1mm, left=2mm, opacitybacktitle=0.6]
