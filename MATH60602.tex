...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Étapes de l'analyse factorielle exploratoire}, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, bottomtitle=1mm, coltitle=black, colback=white, breakable, toptitle=1mm, opacityback=0, colframe=quarto-callout-tip-color-frame, left=2mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Étapes d'une analyse de regroupements}, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, bottomtitle=1mm, coltitle=black, colback=white, breakable, toptitle=1mm, opacityback=0, colframe=quarto-callout-tip-color-frame, left=2mm, arc=.35mm]
