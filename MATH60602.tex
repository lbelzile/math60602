...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{En résumé}, toptitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, coltitle=black, leftrule=.75mm, titlerule=0mm, arc=.35mm, left=2mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Étapes de l'analyse factorielle exploratoire}, toptitle=1mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, coltitle=black, leftrule=.75mm, titlerule=0mm, arc=.35mm, left=2mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Danger de surajustement avec variables catégorielles}, toptitle=1mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, coltitle=black, leftrule=.75mm, titlerule=0mm, arc=.35mm, left=2mm, opacityback=0]
...
Le modèle logistique à cotes proportionnelles spécifie que
\begin{align*}
\frac{\Pr(Y_i > k \mid \mathbf{X}_i)}{\Pr(Y_i \leq k \mid \mathbf{X}_i)} = \frac{p_{i(k+1)} + \cdots + p_{iK}}{p_{i1} + \cdots + p_{ik}} = \exp(\mathbf{X}_i \boldsymbol{\beta} - \zeta_k), \qquad k=1, \ldots, K-1
...
\Pr(Y_i > k \mid \mathbf{X}_i) &= \textrm{expit}(-\eta_k + \beta_1 \mathrm{X}_{i1} + \cdots + \beta_p \mathrm{X}_{ip}), \qquad j =2, \ldots, K.
...
diminution de la cote des femmes \(15\)\% (et donc la probabilité
estimée que la personne vote plus fréquemment est plus faible).

Considérons pour illustrer le rôle des paramètres la prédiction pour une
femme (valeur de la référence). Soit \(p_1\), \(p_2\) et \(p_3\) les
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Étapes d'une analyse de regroupements}, toptitle=1mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, coltitle=black, leftrule=.75mm, titlerule=0mm, arc=.35mm, left=2mm, opacityback=0]
