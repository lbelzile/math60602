...
```{r fig2p1_fig1, echo = FALSE, out.width='90%', fig.align = "center"}
knitr::include_graphics("figures/02-select-e1.png")
```
```{r fig2p1_fig2, echo = FALSE, out.width='90%', fig.align = "center"}
...
print(knitr::kable(x = as.data.frame(cbind(emq[,c(2,1,3:6)], rowMeans(emqcv))), 
             digits = 2, 
             row.names = TRUE,
            col.names = c("\\(\\mathsf{EMQ}\\)",
                          "\\(\\widehat{\\mathsf{EMQ}}_a\\)",
