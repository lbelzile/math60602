...
nous allons seulement l'utiliser pour explorer les patterns des
...
var x11-x14 x21-x24 x3 x4 x5 x61 x62;
run;
...
model y(ref='0') = x11-x14 x21-x24 x3 x4 x5 x61 x62;
by _imputation_;
run;
...
/* PROC MIANALYZE combine les estimations des 50 modèles afin
d'avoir les estimations finales. */

proc mianalyze data=outlogistic;
var intercept x11-x14 x21-x24 x3 x4 x5 x61 x62;
run;
