...
```{r 02-plotEQMa_comput, eval=TRUE, echo=FALSE, cache=TRUE, message = FALSE} 
...
- *Critère d'entrée*: $c$, valeur-_p_ minimale à partir de laquelle une variable peut être incluse dans le modèle
...
- *Critère de sortie*: $c$, valeur-_p_ maximale à partir de laquelle une variable peut être excluse du modèle
...
```{r fig2p2_fig10, echo = FALSE, out.width='65%', fig.align = "center"}
knitr::include_graphics("figures/02-select-e10.png")
```
```{r fig2p2_fig11, echo = FALSE, out.width='70%', fig.align = "center"}
knitr::include_graphics("figures/02-select-e11.png")
```



On peut voir sur le graphique \@ref(fig:fig2p2_fig17) l'historique des valeurs de AIC et BIC à mesure qu'on diminue le nombre de variables dans le modèle: les mêmes variables sont enlevées à chaque étape, mais la valeur optimale du critère est différente pour la sélection finale.
...
```{r fig2p2_fig12, echo = FALSE, out.width='85%', fig.align = "center"}
...
```{r fig2p2_fig13, echo = FALSE, out.width='90%', fig.align = "center"}
