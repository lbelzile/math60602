...
#| fig.height= 8,
#| out.width='80%', 
#| fig.cap = ifelse(knitr::opts_knit$get("rmarkdown.pandoc.to")== "html","Regroupements hiérarchiques sur le sous-ensemble des données, étape par étape","Regroupements hiérarchiques avec la méthode de Ward (solution à trois groupes)")
...
#| out.width='80%', 
#| fig.align = "center", 
#| fig.cap = "Courbe du $R^2$ semi-partiel en fonction des groupements hiérarchiques"
