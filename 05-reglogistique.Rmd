...
Soit $p_{ik}=\P{Y_i=k \mid X_{i1}, \ldots, X_{ip}}$ ($k=0, 1, \ldots, K$) la probabilité que $Y_{ik}$ prenne la valeur $k$. On dénote 
\[S_{ij}=\sum_{k=j}^K p_{ik}= \P{Y_{i} > j - 1 \mid X_{i1}, \ldots, X_{ip}}, \qquad j=1, \ldots, K.
\]
