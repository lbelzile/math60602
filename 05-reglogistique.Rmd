...
```{r demandecredit, eval = TRUE, echo = FALSE, cache = TRUE, fig.cap = "Données de la réserve de Boston sur l'approbation de prêts hypothécaires (1990); données tirées de Stock et Watson (2007).", message = FALSE, warning = FALSE}
library(ggplot2)
