...
```{r fig-f5e1, echo = FALSE, out.width='70%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e1.png")
```

\begin{align*} \vdots \end{align*}

```{r fig-f5e2, echo = FALSE, out.width='70%', fig.align = "center"}
...
```{r fig-f5e4, echo = FALSE, out.width='90%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e4.png")
```

Le tableau @fig-f5e5 donne le nombre de données censurées: parmi les 500 observations, il y a 334 clients qui ont terminé leur abonnement et 166 qui sont censurées (le client est toujours abonné et le temps est donc une borne inférieure de la durée d'abonnement).


```{r fig-f5e5, fig.cap="Fraction de valeurs censurées", echo = FALSE, out.width='60%', fig.align = "center"}
...
```{r fig-f5e6, echo = FALSE, out.width='75%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e6.png")
```

```{r fig-f5e7, echo = FALSE, out.width='75%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e7.png")
```

```{r fig-f5e8, echo = FALSE, out.width='75%', fig.align = "center"}
...
```{r fig-f5e9, echo = FALSE, out.width='55%', fig.align = "center"}
...
Ces courbes sont représentées dans la Figure @fig-f5e10. On voit que la courbe des femmes est systématiquement au-dessus de celle des hommes. Les femmes ont donc tendance à rester abonnées plus longtemps que les hommes, et cette différence est significative. 

```{r fig-f5e10, fig.cap = "Courbes de survie estimées par sexe (Kaplan--Meier)", echo = FALSE, out.width='83%', fig.align = "center"}
...
```{r fig-f5e11, echo = FALSE, out.width='45%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e11.png")
```

```{r fig-f5e12, echo = FALSE, out.width='85%', fig.align = "center"}
...
```{r fig-f5e13, echo = FALSE, out.width='45%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e13.png")
```

```{r fig-f5e14, echo = FALSE, out.width='85%', fig.align = "center"}
...
```{r fig-f5e15, echo = FALSE, out.width='45%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e15.png")
```


```{r fig-f5e16, echo = FALSE, out.width='45%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e16.png")
```


```{r fig-f5e17, echo = FALSE, out.width='45%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e17.png")
```


```{r fig-f5e18, echo = FALSE, out.width='85%', fig.align = "center"}
...
```{r fig-f5e21, echo = FALSE, out.width='80%', fig.align = "center"}
...
```{r fig-f5e22, echo = FALSE, out.width='85%', fig.align = "center"}
...
```{r fig-f5e23, echo = FALSE, out.width='65%', fig.align = "center"}
...
```{r fig-f5e24, echo = FALSE, out.width='65%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e24.png")
```

```{r fig-f5e25, echo = FALSE, out.width='85%', fig.align = "center"}
...
```{r fig-f5e26, echo = FALSE, out.width='65%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e26.png")
```

```{r fig-f5e27, echo = FALSE, out.width='85%', fig.align = "center"}
...
```{r fig-f5e28, echo = FALSE, out.width='65%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e28.png")
```

```{r fig-f5e29, echo = FALSE, out.width='85%', fig.align = "center"}
...
```{r fig-f5e30, echo = FALSE, out.width='85%', fig.align = "center"}
...
```{r fig-f5e31, echo = FALSE, out.width='75%', fig.align = "center"}
knitr::include_graphics("figures/05-survie-e31.png")
```



```{r fig-f5e32, echo = FALSE, out.width='85%', fig.align = "center"}
