...
g1 <- ggplot(data = survrisque,
  ...
  labs(x = "temps",
       y = "",
       subtitle = "fonctions de risque proportionnelles") +
  theme_classic()
...
g3 <- ggplot(data = fsurvie1,
             aes(x = temps)) +
  geom_line(aes(y = survie1a)) +
  geom_line(aes(y = survie1b), col = 2)  +
...
g4 <- ggplot(data = survrisque,
  ...
  labs(x = "temps",
       y = "",
       subtitle = "fonctions de risque non-proportionnelles") +
  theme_classic()
...
g6 <- ggplot(data = fsurvie2,
             aes(x = temps)) +
  geom_line(aes(y = survie2a), col = 2) +
