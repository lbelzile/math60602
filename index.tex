...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, arc=.35mm, colback=white, rightrule=.15mm, bottomtitle=1mm, left=2mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{En résumé}, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, arc=.35mm, colback=white, rightrule=.15mm, bottomtitle=1mm, left=2mm, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Étapes de l'analyse factorielle exploratoire}, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, opacitybacktitle=0.6]
...
\begin{verbatim}
                2.5 %    97.5 %
(Intercept) 21.872043 23.362931
X1           1.801284  2.206154
\end{verbatim}
...
\begin{verbatim}
                2.5 %    97.5 %
(Intercept) 19.664527 20.304148
X1           1.950967  2.104175
X2           4.727644  5.301919
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{data}\NormalTok{(selection1\_train, }\AttributeTok{package =} \StringTok{"hecmulti"}\NormalTok{)}
...
\NormalTok{mod\_cub }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}} \FunctionTok{poly}\NormalTok{(x, }\DecValTok{3}\NormalTok{),}
              \AttributeTok{data =}\NormalTok{ selection1\_train)}
...
-111.908  -34.114    2.079   36.688  142.481 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)   -9.772      5.224  -1.871  0.06446 .  
poly(x, 3)1  824.808     52.242  15.788  < 2e-16 ***
poly(x, 3)2 -281.951     52.242  -5.397 4.88e-07 ***
poly(x, 3)3  160.993     52.242   3.082  0.00269 ** 
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 52.24 on 96 degrees of freedom
Multiple R-squared:  0.7499,    Adjusted R-squared:  0.7421 
F-statistic: 95.96 on 3 and 96 DF,  p-value: < 2.2e-16
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, arc=.35mm, colback=white, rightrule=.15mm, bottomtitle=1mm, left=2mm, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Danger de surajustement}, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, opacitybacktitle=0.6]
...
Wald (valeur-\(p\) de \textless0.0001).\footnote{Pour des raisons
  techniques hors du niveau du cours, le test du rapport de
  vraisemblance pour l'effet de l'interaction est probablement illogique
  ici.}
